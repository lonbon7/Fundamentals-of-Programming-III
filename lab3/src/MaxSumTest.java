...
public final class MaxSumTest
{
   ...
   static private int seqEnd = -1;
    ...
    public static void main( String [ ] args )
    {
       ...
       while(true)
       {
          System.out.println("Which algorithm(1-4)?");
          alg = scanner.nextInt();
       
          System.out.println("How many items?(0 to quit)");
          ...
          totalTime = System.currentTimeMillis() - startTime;
          System.out.println("Time taken to fill the array: " + totalTime + "ms.");
          ...
          {
             startTime = System.currentTimeMillis();
             result = maxSubSum4(numbers);
             totalTime = System.currentTimeMillis() - startTime;
          }
          
          System.out.println("Solving time: " + totalTime + "ms.");
